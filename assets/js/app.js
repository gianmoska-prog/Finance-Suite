...
const translations = {
  en: {
    ...
    academy_title: 'Financial Academy', academy_subtitle: 'Internal training for understanding the workstation, launch economics, Italian fiscal assumptions, and the financial discipline required before production or debt.', assistant_title: 'Financial Assistant', assistant_subtitle: 'The AI layer is not connected yet. For now, use the floating assistant to copy a structured scenario summary or export the current JSON backup.', assistant_status_title: 'Assistant status', assistant_status_hint: 'No API calls are active. No API keys are stored in this file.', assistant_open: 'Open assistant panel', assistant_panel_title: 'MOSCATELLI FINANCIAL ASSISTANT', assistant_panel_status: 'Status: not connected. Export your scenario and paste it into Claude, Grok, Gemini, or ChatGPT for external review.', assistant_copy: 'Copy scenario summary', assistant_export_json: 'Export scenario JSON', assistant_security: 'Never store API keys, bank data, tax codes, or supplier contracts in client-side code or localStorage.', import_confirm_title: 'Load backup?', import_confirm_text: 'This will replace your current workstation state. Save a backup first if you need to preserve the current version.',
